...
//TA MAIS PRA CIMA
    ...
    <button class="btnAzul" onclick="location.href='../devolucao/cadastrarDevolucao.php?lista_id=<?php if(!empty($lista_id)) {echo $lista_id;} echo '&lista_quantidade='; if(!empty($lista_quantidade)) {echo $lista_quantidade;}?>'" type="button">Finalizar seleção</button>
    </div>
