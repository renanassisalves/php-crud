...
<body>
    ...
    ?>
 <!-- <form action="../classes/Devolucao.php" method="POST" style="float: right; margin-bottom:10px; margin-right:10px;">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td class="headerListagem">Data Devolucao</td>
        ...
        if (isset($_GET['pesquisa']))
        {
            ...
            $vetor = Devolucao::listarPesquisa($link, $pesquisa);
        }
        else
        {
            $vetor = Devolucao::listarTodos($link);
        }
